...
class K8sClient:
    ...
    def __init__(self):
        if not self._initialized:
            ...
            self.rbac_v1 = client.RbacAuthorizationV1Api(client.ApiClient(configuration))
    ...
    def get_rbac_v1_api(self) -> client.RbacAuthorizationV1Api:
...
def get_rbac_v1_api() -> client.RbacAuthorizationV1Api:
    """获取 RbacAuthorizationV1Api 客户端"""
    return k8s_client.get_rbac_v1_api()


def create_sa_token(sa_name: str, namespace) -> str:
